...
$select_query=mysqli_query($con,"SELECT * FROM `all`
		WHERE name_of_section='".$_GET['name_of_section']."' 
		AND brand_of_section='".$_GET['brand_of_section']."' 
		AND name_of_category='".$_GET['name_of_category']."' ORDER BY all.id DESC LIMIT 20");
