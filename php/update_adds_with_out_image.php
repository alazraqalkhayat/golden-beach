...
if(!$con){
	echo "noooooooooo";//	image_of_product	
		...
		if (isset($_POST[add_id]) && isset($_POST['name_of_owner']) && isset ($_POST['description']) && isset($_POST['date_of_add'])) {
			//get data from post
			...
			$update_add_query="UPDATE `adds` SET `name_of_owner`='$add_name_of_owner',`description`='$add_description',`date_of_add`='$add_date_of_add'  WHERE add_id=$add_id_of_add";
